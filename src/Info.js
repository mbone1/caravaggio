  ...
  return (
    <>
      ...
      <>
        ...
        {/* <AnimatedText
          {...spingus}
          anchorX={data[0].info[0].coords.x}
          anchorY={data[0].info[0].coords.y}
          position-z={data[0].info[0].coords.z}
          text={text}
          maxWidth={data[0].info[0].maxWidth}
          // rotation={props.rotate}
          fontSize={0.2}>
          <meshPhongMaterial attach="material" />
        </AnimatedText> 
        
        this is for the title and description...
        <AnimatedText
          {...spongus}
          anchorX={13.9}
          anchorY={-0.8}
